...
Examples:
  python3 audit_mbo_mbp_data.py --mbo rich_mbo.csv --mbp rich_mbp.csv
  python3 audit_mbo_mbp_data.py --mbo /data/mbo.parquet --mbp /data/mbp.parquet --expected-root 6B
  python3 audit_mbo_mbp_data.py --mbo raw/mbo --mbp raw/mbp --json-out audit_report.json --fail-on high
"""
