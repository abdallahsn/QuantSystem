...
## Summary
- 2093 nodes · 6380 edges · 95 communities (75 shown, 20 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 727 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cb433a91`
...
6. `str` - 52 edges
7. `run_training_pipeline()` - 46 edges
...
- `main()` --calls--> `_configure_stdio_utf8()`  [INFERRED]
  train_v19.py → backtest_v19.py
- `DataFrame` --uses--> `DynamicTargetManager`  [INFERRED]
  backtest_v19.py → modules/dynamic_target.py
- `DataFrame` --uses--> `V19PredictionEngine`  [INFERRED]
  backtest_v19.py → predict_v19.py
- `str` --uses--> `DynamicTargetManager`  [INFERRED]
  backtest_v19.py → modules/dynamic_target.py
...
Cohesion: 0.07
Nodes (86): deep_validation.py — 5 Scientific Tests for V16Pro-3, read_table(), التعديل 4: تصنيف الـ Regime باستخدام Wasserstein Distance.      لماذا Wasserstei, WassersteinRegimeClassifier, _accumulate_integrity_snapshot(), _add_rolling_context(), _apply_continuous_contract_root(), _artifact_phase_dir() (+78 more)

### Community 2 - "Market Data Cleaning"
Cohesion: 0.07
Nodes (63): main(), plot_5m_catboost.py - Standalone 5m CatBoost dashboard, _apply_decision_policy_to_bars(), _apply_signal_pipeline_to_bars(), _build_confusion_chart(), _build_dashboard(), _build_price_hover_trace(), _build_turns_table() (+55 more)

### Community 3 - "Backtest Diagnostics and Utilities"
Cohesion: 0.06
Nodes (71): _assert_single_contract_df(), _binary_ece(), _build_backtest_window_mask(), _build_visual_diagnostics(), _coerce_row_aligned_array(), _configure_stdio_utf8(), _coverage_counts(), _coverage_sidecar_candidates() (+63 more)
...
Cohesion: 0.15
Nodes (49): bool, DataFrame, int, str, auto_calibrator.py — معايرة تلقائية من الداتا, LiquiditySweepDetector, MomentumContextEngine, LOBTensorBuilder (+41 more)

### Community 7 - "CatBoost Model Management"
Cohesion: 0.07
Nodes (27): Enum, CatBoostQuantBrain, bool, float, int, ndarray, str, catboost_brain.py — CatBoost Quantitative Brain ════════════════════════════════ (+19 more)

### Community 8 - "Configuration and Logging"
Cohesion: 0.09
Nodes (36): append_dynamic_orderbook_features(), build_event_filter(), _build_quality_thresholds(), build_training_dataset(), compute_dynamic_levels(), _direction_from_future_return(), engineer_features(), EventGate (+28 more)
...
Cohesion: 0.10
Nodes (29): IsotonicRegression, _build_tcn_block(), _input_shape_matches(), _late_fusion_block(), _load_keras_model_allow_lambda(), make_volatility_weighted_loss(), MetaLearnerLSTM, MetaLearnerTCNLSTM (+21 more)

### Community 12 - "LSTM Meta-Learner"
Cohesion: 0.09
Nodes (22): ActiveTrade, DynamicTargetManager, bool, float, int, str, dynamic_target.py — V18: Regime-Aware Execution + Pipeline Integration ═════════, يفتح صفقة جديدة مع استخدام scan_result الكامل.          Parameters         ----- (+14 more)

### Community 13 - "Dynamic Orderbook Labels"
Cohesion: 0.11
Nodes (41): V19 Default Config, Meta Learner, infer_meta_feature_layout(), resolve_meta_feature_names(), _configure_stdio_utf8(), _pool_worker_init(), Windows consoles often default to cp1256; emoji/unicode logs then crash on print, Ensure worker processes (spawn) can emit UTF-8 without UnicodeEncodeError. (+33 more)
...
Cohesion: 0.12
Nodes (40): _adaptive_tree_depth(), _apply_scaler_to_stat_frame(), _apply_wall_scales(), _assert_lob_event_alignment(), _assert_no_forbidden_model_inputs(), _binary_ece(), _build_inner_time_split(), build_safe_sequences() (+32 more)
...
Cohesion: 0.12
Nodes (24): _clip_numeric_series(), fit_numeric_scaler_param(), _load_json(), normalize_timestamp_columns(), prepare_feature_frame(), prepare_feature_row(), bool, DataFrame (+16 more)
...
Cohesion: 0.18
Nodes (32): load_v19_config(), load_feature_artifact(), EventLogWriter, ExecutionLogger, emit_alerts(), load_baseline_from_artifacts(), load_jsonl(), MonitoringState (+24 more)

### Community 23 - "Feature Scaling and Normalization"
Cohesion: 0.12
Nodes (28): append_dynamic_orderbook_features(), build_event_filter(), _build_quality_thresholds(), build_training_dataset(), compute_dynamic_levels(), _direction_from_future_return(), engineer_features(), kalman_trend() (+20 more)
...
Cohesion: 0.15
Nodes (18): EventGate, Online deterministic replica of the offline event filter., DataQualityLogger, PredictionLogger, RiskLogger, DailyLossGuard, يوقف التداول تلقائياً عند تجاوز حد الخسارة اليومية.          المنطق:     - max_d, تصفير العدادات اليومية (+10 more)

### Community 26 - "Training Data Alignment"
Cohesion: 0.14
Nodes (26): _load_csv(), _compare(), evaluate_release_gates(), bool, float, str, release_gates_v19.py - Release gate evaluation for QuantSystem V19, save_gate_report() (+18 more)

### Community 27 - "Intrabar Microstructure Aggregation"
Cohesion: 0.19
Nodes (10): _directional_metrics(), main(), _pseudo_prob_head(), DataFrame, ndarray, Scalar regression output in (0,1) -> [p, 1-p] aligned with meta stacking., Meta-off: soft regression path uses a lower bar than classifier probs., V19PredictionEngine (+2 more)
...
Cohesion: 0.22
Nodes (22): main(), Smoke checks for QuantSystem V19 validation guards.  This script avoids model im, _sample_frame(), assert_label_timestamps(), assert_no_label_leakage(), _num(), bool, DataFrame (+14 more)
...
Cohesion: 0.15
Nodes (21): build_replay_dataset(), _coerce_optional_timestamp(), filter_timerange(), normalize_ts(), bool, DataFrame, float, int (+13 more)
...
Cohesion: 0.27
Nodes (22): Feature Artifact V19, _abs(), checkpoint_dir(), _ensure_dir(), _existing_columns_for_table(), iter_table_chunks(), load_artifact_manifest(), parquet_shard_paths() (+14 more)

### Community 40 - "TCN-LSTM Meta-Learner"
Cohesion: 0.24
Nodes (21): Timestamp, _align_lob_to_rows(), _assert_single_contract_df(), build_event_training_view(), build_inference_scaler_params(), _build_row_time_mask(), _event_gate_train_prefix(), _fit_scaler_params_from_frame() (+13 more)

### Community 41 - "System Readiness Checks"
Cohesion: 0.21
Nodes (19): decide_runtime_mode(), evaluate_system_health(), _load_shadow_approval(), _manifest_exists(), bool, str, failsafe_v19.py - Explicit degradation and runtime gating policies for V19, _schema_manifest_match() (+11 more)
...
Cohesion: 0.19
Nodes (11): _infer_depth_view(), _load_keras_model_allow_lambda(), bool, float, int, ndarray, str, lob_transformer.py - LOB depth encoder for late-fusion path (+3 more)
...
Cohesion: 0.18
Nodes (10): LiquidityTrapDetector, OrderBookSnapshotEngine, float, int, str, Liquidity Trap Score:     يكشف فخاخ السيولة بناءً على علاقة الـ OBI بحركة السعر., يحسب OBI من كل snapshot MBP10.     V16Pro: أضاف OBI Z-Score Dynamic, يكتشف الـ Spoofing من خلال مقارنة الـ Snapshot الحالي بالسابق.         Spoofing (+2 more)
...
Cohesion: 0.17
Nodes (13): _deep_merge(), default_release_gates_path_for_profile(), _load_any(), load_release_gates(), str, config_v19.py - Config loading helpers for QuantSystem V19, Return the release-gate file for a V19 profile.      V19 currently ships one con, main() (+5 more)
...
Cohesion: 0.27
Nodes (10): align_probability_columns(), fill_uncovered_one_hot(), fill_uncovered_probabilities(), float, int, ndarray, oof_stacking.py - Shared helpers for leakage-safe stacked models, Expand/crop probability columns to a fixed output width.      This is useful whe (+2 more)
...
Cohesion: 0.29
Nodes (7): _adaptive_tree_early_stopping_rounds(), _cli_argv_looks_like_direct_train_v19(), _keras_meta_checkpoint_has_aux(), _oof_isotonic_enabled(), bool, True عند تشغيل الملف كسكربت (وليس عند import من plot_5m_catboost أو غيره)., OOF fold calibration is opt-in because isotonic can overfit time folds.

### Community 66 - "TensorFlow GPU Installation"
Cohesion: 0.43
Nodes (6): main(), patch_file(), int, Path, str, _repl()

### Community 67 - "Artifact Discovery"
Cohesion: 0.48
...
### Community 69 - "GPU Library Diagnostics"
Cohesion: 0.83
Nodes (3): ensure_venv(), retry(), install_tf_gpu_cu12.sh script

### Community 70 - "Diagnostics Package"
Cohesion: 0.67
...
### Community 72 - "Environment Repair Scripts"
Cohesion: 0.67
Nodes (3): Codex Audit Plan, QuantSystem V19, Stage 1 Refinery

### Community 73 - "Tooling Namespace"
Cohesion: 0.67
Nodes (3): PyTorch, DeepScalper, TradeMaster

### Community 74 - "Package Initialization"
Cohesion: 0.67
Nodes (3): NautilusTrader, StockSharp Designer, StockSharp Hydra

## Knowledge Gaps
- **126 isolated node(s):** `int`, `ArgumentParser`, `ndarray`, `Timestamp`, `Namespace` (+121 more)
...
- **Why does `deque` connect `Backtest Diagnostics and Utilities` to `Transformer and LSTM Brains`, `Live Prediction Pipeline`, `CatBoost Model Management`, `Configuration and Logging`, `DeepLOB CNN Models`, `Meta-Learner Training Entrypoint`, `Refinery Comparison Reports`, `Feature Scaling and Normalization`, `Microstructure and Iceberg Detection`, `Training Workflow Orchestration`, `Rolling CatBoost Predictor`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `V19PredictionEngine` connect `Intrabar Microstructure Aggregation` to `Market Data Cleaning`, `Backtest Diagnostics and Utilities`, `Transformer and LSTM Brains`, `Soft Label Quality Control`, `Training Dataset Engineering`, `DeepLOB CNN Models`, `Contract Data Extraction`, `Orderbook Liquidity Detection`, `Training Workflow Orchestration`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `Feature Artifact V19` connect `Interactive Label Visualizer` to `CatBoost Dashboard and Reporting`, `Backtest Diagnostics and Utilities`, `LOB Transformer Model`, `Label and Feature Auditing`, `Dynamic Orderbook Labels`, `Orderbook Liquidity Detection`, `Training Workflow Orchestration`, `Training Data Alignment`, `Position Sizing and Slippage`?**
